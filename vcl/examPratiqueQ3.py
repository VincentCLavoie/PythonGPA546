...
# Symboles
theta1, theta2, theta3, theta4, d1, d2, d3, nx, ox, ax, px, ny, oy, ay, py, nz, oz, az, pz = symbols('theta1, theta2, theta3, theta4, d1, d2, d3, n_x, o_x, a_x, p_x, n_y, o_y, a_y, p_y, n_z, o_z, a_z, p_z')
...
H1 = dh_matrix(theta1, 650, 0, -(pi/2))
H2 = dh_matrix(-(pi/2), d2, 400, pi)
H3 = dh_matrix(theta3, 0, 600, 0)
H4 = dh_matrix(theta4, 0, 420, 0)
